...
export default function RiskAnalysisCard({ risk }) {
  if (!risk) return null;
  const { level, levelColor, volatility, drawdown, beta, advice } = risk;
  return (
    <View style={styles.card}>
      ...
      <Metric label="Drawdown Risk" value={drawdown} color={bandColor(drawdown)} />
      <Metric label="Portfolio Beta" value={beta.toFixed(2)} color="#FFD700" />
